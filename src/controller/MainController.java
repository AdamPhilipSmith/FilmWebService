...
public class MainController {
	...
	public static void main(String[] args) throws SQLException {
		...
		// Inserts a film to the database and prints out an int to say if it was
		// successful or not.
		Film insert = new Film(99, "test", 1984, "test", "test", "test");

		System.out.println(fdao.insertFilm(insert));

		// Updates a films ID with a new ID. Printing out an int to say if this was
		// successful.
		System.out.println(fdao.updateID(88, 99));

		// Deletes the film with the given ID. Printing out an int to say if this was
		// successful.
		try {
