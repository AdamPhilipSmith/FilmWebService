...
public class updateID extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//PrintWriter out = response.getWriter();
				...
				int i =fdao.updateID(newFilmIDint, currentFilmIDint);
			
				// Prints to console alerting the user if a film has been updated and if so, how many. (Multiple films may exist with the same ID)
